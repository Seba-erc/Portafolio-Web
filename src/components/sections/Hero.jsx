...
export default function Hero() {
  ...
  return (
    <section id="inicio" className="container" style={{ minHeight: '100vh', display: 'flex', alignItems: 'center', padding: '6rem 2rem 2rem' }}>
      
      <div className="hero-split">
        
        {/* COLUMNA IZQUIERDA: Contacto / Perfil */}
        <div className="glass-card" style={{ display: 'flex', flexDirection: 'column', gap: '1.5rem', padding: '3rem 2rem' }}>
          ...
          <div style={{ textAlign: 'center', marginBottom: '0.5rem' }}>
            ...
            <p style={{ margin: '0.5rem 0 0 0', color: 'var(--accent-hover)', fontWeight: '600' }}>Ingeniería en Informática</p>
            <p style={{ margin: '0.2rem 0 0 0', fontSize: '0.9rem', color: 'var(--text-secondary)' }}>Instituto Profesional Santo Tomás</p>
          </div>

          <div>
            <h3 style={{ color: 'var(--accent-hover)', marginBottom: '0.8rem', fontSize: '1.1rem' }}>Correos Electrónicos</h3>
            ...
            <div style={{ margin: '0.5rem 0', display: 'flex', flexDirection: 'column', gap: '0.2rem' }}>
              <span style={{ fontSize: '0.9rem', color: 'var(--text-secondary)' }}>Institucional:</span>
              <div style={{ display: 'flex', alignItems: 'center', gap: '0.5rem' }}>
          ...
          <div>
            <h3 style={{ color: 'var(--accent-hover)', marginBottom: '0.8rem', fontSize: '1.1rem' }}>Teléfono / WhatsApp</h3>
          ...
          <div>
            <h3 style={{ color: 'var(--accent-hover)', marginBottom: '0.8rem', fontSize: '1.1rem' }}>Redes Profesionales</h3>
        ...
        <div className="glass-card" style={{ display: 'flex', flexDirection: 'column', justifyContent: 'center', padding: '3rem 2.5rem' }}>
          ...
          <p style={{ fontSize: '1.1rem', color: 'var(--text-secondary)', marginBottom: '2.5rem' }}>
            Estudiante apasionado por el desarrollo de software. Buscando mi primera práctica profesional para aportar, aprender y crecer enfrentando desafíos reales de ingeniería.
          </p>
          
          <div className="hero-actions" style={{ justifyContent: 'flex-start' }}>
            <a href="#proyectos" className="btn btn-primary">Ver Mis Proyectos</a>
            <a href="#certificados" className="btn btn-outline">Mis Certificados</a>
            <a href="/docs/CV.pdf" target="_blank" rel="noopener noreferrer" className="btn btn-primary">Ver CV</a>
            <a href="/docs/Malla.pdf" target="_blank" rel="noopener noreferrer" className="btn btn-outline">Malla Curricular</a>
          </div>
        </div>
