...
export default function Certificates() {
  ...
  return (
    <section id="certificados" className="container">
      <h2 className="section-title">Certificaciones</h2>
      
      <div className="certifications-grid">
        {certificates.map((cert, index) => (
          <div key={index} className="glass-card" style={{ display: 'flex', flexDirection: 'column', padding: '1.2rem', alignItems: 'center' }}>
            ...
            <a 
              ...
              title={cert.pending ? "Certificado en progreso" : "Abrir PDF en tamaño completo"}
